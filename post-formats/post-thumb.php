<?php if(!is_singular()) : ?>
	<?php if ( has_post_thumbnail() ) {	?>
		<?php if ( ( '' == of_get_option('post_image_size') ) || ('normal' == of_get_option('post_image_size')) ) {	?>
			<figure class="featured-thumbnail thumbnail"><a href="<?php the_permalink(); ?>" title="<?php esc_attr_e(__('Permalink to:', 'duena'));?> <?php the_title(); ?>"><?php the_post_thumbnail(); ?></a></figure>
		<?php } ?>
	<?php }	?>
<?php else :?>
	<?php
